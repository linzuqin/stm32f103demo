...
void OLEd_DataUp(void);

/*********************函数声明*/

extern uint8_t OLED_BackBuffer[8][128];
void OLED_SwapBuffer(void);
void OLED_ClearBackBuffer(void);
void DrawCharToBackBuffer(uint8_t x, uint8_t y, char ch, uint8_t font);
void FadeInOut(uint8_t direction);
void ShowCubeAnimation(void);
